...
export default function Form({ setText, text, handleSubmit, errorMessage, sentiment, chartData }) {
  return (
    <form
      ...
      {sentiment && (
        <div className='mt-8 text-3xl font-bold flex flex-col justify-center items-center'>
          <div className='border-2 border-purple-600 text-white py-2 px-4 rounded-lg'>
